...
import { Calendar, Mail, FileText, Loader2, Eye, CheckCircle, XCircle, Users, Mic } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Interviewed Candidates</h1>
            <p className="text-sm text-muted-foreground">Candidates who have completed interviews</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-8">
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              <CardDescription>High Performers (8+)</CardDescription>
          ...
          {applicants.length === 0 ? (
            <Card className="shadow-sm">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">No Interviewed Candidates</h3>
                <p className="text-muted-foreground">No candidates have been interviewed yet.</p>
              </CardContent>
            </Card>
          ) : (
