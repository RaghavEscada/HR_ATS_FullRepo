...
import { Calendar, Mail, FileText, Loader2, Eye, CheckCircle, XCircle } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">New applications awaiting review</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-8">
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-blue-600">{applicants.length}</CardTitle>
            </CardHeader>
          </Card>
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
          ...
          {applicants.length === 0 ? (
            <Card className="shadow-sm">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">No Applied Candidates</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Avatar className="h-12 w-12">
                        <AvatarImage src={`https://ui-avatars.com/api/?name=${applicant.first_name}+${applicant.last_name}&background=3b82f6&color=fff`} alt={`${applicant.first_name} ${applicant.last_name}`} />
                        <AvatarFallback>
