...
import { Calendar, Mail, FileText, Loader2, Eye, CheckCircle, Users, Star } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Hired Candidates</h1>
            <p className="text-sm text-muted-foreground">Successfully hired team members</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-8">
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-green-600">{applicants.length}</CardTitle>
            </CardHeader>
          </Card>
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              <CardDescription>Top Performers (9+)</CardDescription>
              <CardTitle className="text-3xl text-purple-600">
                {applicants.filter(app => (app.cv_scoring || 0) >= 9).length}
              </CardTitle>
            </CardHeader>
          </Card>
        </div>
          ...
          {applicants.length === 0 ? (
            <Card className="shadow-sm">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">No Hired Candidates</h3>
                <p className="text-muted-foreground">No candidates have been hired yet.</p>
              </CardContent>
            </Card>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Avatar className="h-12 w-12">
                        <AvatarImage src={`https://ui-avatars.com/api/?name=${applicant.first_name}+${applicant.last_name}&background=10b981&color=fff`} alt={`${applicant.first_name} ${applicant.last_name}`} />
                        <AvatarFallback>
